...
data class Nft(
  ...
  @SerializedName("originalMedia") var originalMedia: OriginalMedia? = OriginalMedia(),
  @SerializedName("saleInfoNft") var saleInfoNft: SaleInfoNft? = SaleInfoNft(),
  @SerializedName("offersInfo") var offersInfo: ArrayList<OffersInfo> = arrayListOf(),
  ...
  @SerializedName("nftValue") var nftValue: NftValue? = NftValue()
